...
complicated than the usual version since you have to allocate and index into 
an array instead of just printing, and we vary the start/end instead of 
...
let a = fizzBuzz(1, 6); //→ 1,2,Fizz,4,Buzz
let b = fizzBuzz(1, 8); //→ 1,2,Fizz,4,Buzz,Fizz,7
let c = fizzBuzz(1, 11); //→ 1,2,Fizz,4,Buzz,Fizz,7,8,Fizz,Buzz
