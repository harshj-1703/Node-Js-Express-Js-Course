...
an int value with 0=no, 1=maybe, 2=yes. If either of you is 
very stylish, 8 or more, then the result is 2 (yes). With the 
...
let a = dateFashion(5, 10); //→ 2
let b = dateFashion(5, 2); //→ 0
let c = dateFashion(5, 5); //→ 1
